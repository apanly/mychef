...
default['anjukeinc']['mysql_tarball_url'] = 'http://downloads.mysql.com/archives/mysql-5.5/mysql-5.5.28.tar.gz'
...
default['anjukeinc']['php_redis_tarball_url'] = 'http://pecl.php.net/get/redis-2.2.4.tgz'
